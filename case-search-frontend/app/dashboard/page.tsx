      ...
      <div className="mx-auto max-w-7xl p-4 md:p-6">
          ...
          <div className="px-4 py-4 md:px-6 md:py-5 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 rounded-md bg-slate-600 px-4 py-2 text-white font-medium shadow-sm hover:bg-slate-700 transition-colors"
              >
                Logout
              </button>
            </div>
        ...
        <div className="bg-white rounded-lg shadow-sm ring-1 ring-slate-200 overflow-hidden mb-6">
          <div className="px-4 py-4 md:px-6">
            <h2 className="text-sm font-semibold text-slate-800 mb-4">Search Cases</h2>
            ...
            {(searchFilters.caseNo || searchFilters.year || searchFilters.policeStation) && (
              <div className="mt-4 flex items-center gap-2">
                <button
                  onClick={() => {
                    setSearchFilters({ caseNo: "", year: "", policeStation: "" });
                    setPage(1);
                  }}
